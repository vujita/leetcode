...
exports.optionalRequireCwd = void 0;
exports.setAppPathAtTopNodeModules = setAppPathAtTopNodeModules;
exports.setAppPath = setAppPath;
exports.setDefaultLog = setDefaultLog;
exports._getRequire = _getRequire;
...
function setAppPathAtTopNodeModules(appPath) {
 ...
 */
function _getRequire(callerRequire, fallbackPath) {
    if (!callerRequire) {
        return (0, require_at_1.default)(fallbackPath || process.cwd());
    }
    else if (typeof callerRequire === "string") {
        try {
            return (0, require_at_1.default)(new node_url_1.URL(callerRequire).pathname);
        }
        catch {
            return (0, require_at_1.default)(callerRequire);
        }
    }
    else {
...
function _resolvePath(request, opts) {
    try {
        if (node_path_1.default.isAbsolute(request)) {
            return request;
        }
        if (request.startsWith(".")) {
            return node_path_1.default.join(node_path_1.default.dirname(opts.require.resolve.paths("")[0]), request);
        }
    }
    catch {
        //
    ...
    try {
        return node_path_1.default.dirname(theRequire.resolve(request + "/package.json"));
    }
    catch {
        //
    }
    try {
        return node_path_1.default.join(theRequire.resolve.paths("")[0], request);
    }
    catch {
        //
    }
 ...
 * calling context.
 */
exports.optionalRequireCwd = makeOptionalRequire(process.cwd());
//# sourceMappingURL=optional-require.cjs.map
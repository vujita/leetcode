export declare function setAppPathAtTopNodeModules(appPath: string): string;
export declare function setAppPath(path: string): void;
/**
 ...
 */
export declare function _getRequire(callerRequire: NodeJS.Require | string, fallbackPath?: string): NodeJS.Require;
/**
 ...
 */
export declare function tryRequire(callerRequire: NodeJS.Require | string, path: string, optsOrMsg?: OptionalRequireOpts | string | true): unknown;
/**
 ...
 */
export declare function tryResolve(callerRequire: NodeJS.Require | string, path: string, optsOrMsg?: OptionalRequireOpts | string | true): string;
/**
 ...
 */
export declare function makeOptionalRequire<T = any>(callerRequire: NodeJS.Require | string, log?: (message: string, path: string) => void): OptionalRequireFunction<T>;
/**

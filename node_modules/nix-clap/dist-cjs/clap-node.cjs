...
class ClapNode {
    ...
    constructor(name, alias, parent) {
        ...
        this.argsMap = {};
        if (parent) {
            Object.defineProperty(this, symbols_ts_1._PARENT, {
                value: parent,
                configurable: true,
                enumerable: false,
                writable: true
    ...
    get parent() {
        return this[symbols_ts_1._PARENT];
    }
    getParent() {
        return this.parent;
    }
}
exports.ClapNode = ClapNode;
//# sourceMappingURL=clap-node.cjs.map
...
exports.noop = void 0;
exports.setHelpZebra = setHelpZebra;
exports.isHelpZebraEnabled = isHelpZebraEnabled;
exports.resetZebraIndex = resetZebraIndex;
exports.nextZebraIndex = nextZebraIndex;
exports.padLeftFill = padLeftFill;
exports.camelCase = camelCase;
exports.validParseInt = validParseInt;
exports.cbOrVal = cbOrVal;
exports.dup = dup;
exports.noAnsiLen = noAnsiLen;
exports.padStr = padStr;
exports.padLeft = padLeft;
exports.fitLine = fitLine;
exports.fitLines = fitLines;
exports.toBoolean = toBoolean;
exports.isBoolean = isBoolean;
exports.isNumber = isNumber;
exports.prefixOption = prefixOption;
exports.getTerminalWidth = getTerminalWidth;
const strip_ansi_ts_1 = require("./strip-ansi.cjs");
 ...
 */
function padLeftFill(str, width) {
 ...
 */
function validParseInt(s, defaultN) {
    if (s) {
...
function noAnsiLen(str) {
    return (0, strip_ansi_ts_1.stripAnsi)(str).length;
}
/**

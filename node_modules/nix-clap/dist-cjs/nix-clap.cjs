...
exports.NixClap = exports.defaultExit = exports.defaultOutput = void 0;
const path_1 = __importDefault(require("path"));
const xtil_ts_1 = require("./xtil.cjs");
const events_1 = __importDefault(require("events"));
const parser_ts_1 = require("./parser.cjs");
const command_base_ts_1 = require("./command-base.cjs");
const base_ts_1 = require("./base.cjs");
const command_base_ts_2 = require("./command-base.cjs");
 ...
 * @public
 */
class NixClap extends events_1.default {
    /**
    ...
    constructor(_config = {}) {
        ...
        (0, xtil_ts_1.setHelpZebra)(config.helpZebra !== false);
        ...
        this._helpOpt = config.hasOwnProperty("help")
            ...
            : {
                ...
                args: "[cmds string..]",
                desc: () => {
                    const cmdText = this._rootCommand.subCmdCount > 0 ? " Add command path to show its help" : "";
        ...
        this.output = config.output || exports.defaultOutput;
        this._evtHandlers = config.noDefaultHandlers
            ? {}
            : {
                "pre-help": xtil_ts_1.noop,
                help: parsed => {
                    var _a, _b, _c;
                    ...
                    const helpArgs = (_c = (_b = (_a = parsed.command.optNodes) === null || _a === void 0 ? void 0 : _a.help) === null || _b === void 0 ? void 0 : _b.argsMap) === null || _c === void 0 ? void 0 : _c.cmds;
                    if (helpArgs && helpArgs.length > 0) {
                        helpCmdPath = helpArgs;
                    }
                    else if (parsed.helpNode && !(0, base_ts_1.isRootCommand)(parsed.helpNode.alias)) {
                        // Build command path from helpNode up to (but not including) root
                        helpCmdPath = [];
                        let node = parsed.helpNode;
                        while (node && !(0, base_ts_1.isRootCommand)(node.alias)) {
                            helpCmdPath.unshift(node.name);
                            node = node[symbols_ts_1._PARENT];
                        }
                    }
                    /* c8 ignore next */
        ...
        if (!config.noDefaultHandlers) {
            this.on("exit", exports.defaultExit);
        }
     ...
     */
    _addHelpToSubCommands(commands) {
        /* c8 ignore next */ if (!this._helpOpt)
            return;
    ...
    init2(rootCommandSpec = {}) {
        ...
        if (this._version) {
            ...
            Object.keys(options).forEach(k => {
                const opt = options[k];
                if (opt.alias)
                    verAlias = verAlias.filter(x => opt.alias.indexOf(x) < 0);
            });
        ...
        const rootCommandSpecFinal = {
            alias: base_ts_1.rootCommandName,
            ...
            allowUnknownOption: (_a = rootCommandSpec.allowUnknownOption) !== null && _a !== void 0 ? _a : this._config.allowUnknownOption
        };
        this._rootCommand = new command_base_ts_1.CommandBase(this._name || "program", rootCommandSpecFinal, this._config);
        command_base_ts_2.unknownCommandBase.ncConfig = this._config;
        command_base_ts_2.unknownCommandBase.parent = this._rootCommand;
        command_base_ts_1.unknownCommandBaseNoOptions.ncConfig = this._config;
        command_base_ts_1.unknownCommandBaseNoOptions.parent = this._rootCommand;
        return this;
    }
    /**
    ...
    makeHelp(cmdPath) {
        ...
        const isShowingRootHelp = !cmdName && (0, base_ts_1.isRootCommand)(cmd.alias[0]);
        if (this._usage && cmd) {
        ...
        if (usageMsg) {
            ...
            const hasRootArgs = (0, base_ts_1.isRootCommand)(cmd.alias[0]) && cmd.verbatimArgs;
        ...
        const makeOptionsHelp = () => {
            ...
            if (cmd.name && !(0, base_ts_1.isRootCommand)(cmd.alias[0])) {
     ...
     */
    _findHelpNode(cmdNode) {
        var _a;
        if (((_a = cmdNode.optNodes.help) === null || _a === void 0 ? void 0 : _a.source) === "cli") {
            return cmdNode;
        }
    ...
    _checkFailures(parsed) {
        ...
        if (this._version && ((_a = parsed.command.optNodes.version) === null || _a === void 0 ? void 0 : _a.source) === "cli") {
            this.emit("version");
            return true;
        }
    ...
    parse2(argv, start = 0) {
        ...
        if (start > 0 && this._name === undefined) {
            this._name = path_1.default.basename(argv[start - 1], ".js");
            this._rootCommand.name = this._name;
        }
        const parser = new parser_ts_1.Parser(this);
     ...
     * @private
     */
    _shouldExecuteRootCommand(command, count) {
...
exports.NixClap = NixClap;
//# sourceMappingURL=nix-clap.cjs.map
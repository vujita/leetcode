...
const node_generator_ts_1 = require("./node-generator.cjs");
...
class Parser {
    ...
    _addNodeToList(node) {
        if (this._nodeList.length > 0) {
            ...
            Object.defineProperty(node, symbols_ts_1._PREV, {
                value: l,
                configurable: true,
                enumerable: false,
                writable: true
            });
            Object.defineProperty(l, symbols_ts_1._NEXT, {
                value: node,
                configurable: true,
                enumerable: false,
                writable: true
     ...
     */
    parse(argv, start, command) {
        var _a, _b;
        this._argv = argv;
        let rootNode = command ||
            new command_node_ts_1.CommandNode(this._nc._rootCommand.name, this._nc._rootCommand.alias[0], this._nc._rootCommand);
        ...
        const hasDefaultCommand = ((_b = (_a = this._nc._rootCommand) === null || _a === void 0 ? void 0 : _a.ncConfig) === null || _b === void 0 ? void 0 : _b.defaultCommand) !== undefined;
        ...
        const skipExecDefault = this._nc._skipExecDefault === true;
        ...
        if (!hasNonOptionArgs && hasDefaultCommand && !skipExecDefault && !hasHelpOrVersion) {
            ...
            if (matched.cmd) {
                const defaultCmdNode = new command_node_ts_1.CommandNode(matched.name, matched.alias, matched.cmd);
                ...
                const rootBuilder = new node_generator_ts_1.ClapNodeGenerator(rootNode);
                const defaultCmdBuilder = new node_generator_ts_1.ClapNodeGenerator(defaultCmdNode, rootBuilder);
                ...
                this._builderStack = [new node_generator_ts_1.ClapNodeGenerator(rootNode)];
            }
        }
        else {
            this._builderStack = [new node_generator_ts_1.ClapNodeGenerator(rootNode)];

 ...
 */
export function setHelpZebra(enabled) {
    _helpZebra = enabled;
}
/**
 ...
 */
export function isHelpZebraEnabled() {
    return _helpZebra;
}
 ...
 */
export function padLeftFill(str, width) {
 ...
 */
export function validParseInt(s, defaultN) {
    if (s) {
 ...
 */
export function padStr(str, width) {
 ...
 */
export function fitLine(strs, margin, indent, lineWidth) {
 ...
 */
export function fitLines(strs, margin, indent, leftWidth, lineWidth) {
    if (strs.length === 0)
        return [];
    if (strs.length === 1)

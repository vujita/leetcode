...
import { CommandBase, unknownCommandBaseNoOptions } from "./command-base.js";
...
export class NixClap extends EventEmitter {
    ...
    init2(rootCommandSpec = {}) {
        ...
        this._rootCommand = new CommandBase(this._name || "program", rootCommandSpecFinal, this._config);
...
//# sourceMappingURL=nix-clap.js.map